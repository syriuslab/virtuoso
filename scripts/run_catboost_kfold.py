"""
CatBoost  │  5-fold CV  │  Early stopping  │  CPU-only
"""
...
def run_catboost_kfold(X_path, y_path, prefix, n_splits=5, sample_frac=1.0):
    ...
    print(f"\n📊 {prefix} — CatBoost ({n_splits}-fold CV)")
...
if __name__ == "__main__":
    ...
    args=p.parse_args()
    run_catboost_kfold(args.X,args.y,args.prefix,args.folds,args.sample)
